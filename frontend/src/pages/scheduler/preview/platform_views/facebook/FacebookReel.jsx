...
const FacebookReel = ({ 
  ...
  const content = postData?.content?.facebook || '';
  ...
  return (
      ...
      >
        ...
        <div className="absolute inset-0">
          {/* Action buttons - Now positioned absolutely at the bottom right */}
          <div className="absolute bottom-20 right-2 w-16 flex flex-col items-center space-y-6">

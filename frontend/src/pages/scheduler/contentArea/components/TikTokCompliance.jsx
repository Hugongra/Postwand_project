      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <button
            ...
            className="w-full px-3 py-2 text-left bg-white border border-gray-300 rounded-lg text-sm flex items-center justify-between"
          >
          ...
          {isPrivacyDropdownOpen && creatorInfo?.privacy_level_options && (
            <div className="absolute z-1 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-y-auto">

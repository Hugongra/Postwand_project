...
const Register = () => {
  ...
  const handleSignUpWithGoogle = async (googleResponse) => {
    setFormError('');
    setIsLoading(true);

    const response = await api.GoogleSignIn(googleResponse);
  ...
  const handleRegister = async (e) => {
    ...
    setIsLoading(false);
    if (!response.ok) {
        setFormError(data.error || t('auth.failedToSendVerificationCode'));
        return;
    }
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      className={`pl-10 p-3 text-sm w-full border ${
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`pl-10 pr-10 p-3 text-sm w-full border ${

            ...
            <div className="w-[65%]">
              ...
              <div className="w-full max-w-[98%] mx-auto bg-[#FDFDFD] rounded-lg shadow p-6 animate-pulse">
                ...
                <div className="space-y-2 mb-6">
                  <div className="w-40 h-5 bg-gray-200 rounded-lg"></div>
                  <div className="flex justify-between">
                    <div className="w-1/2 h-10 bg-gray-200 rounded-lg mr-2"></div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-full flex items-center mb-2">
                    ...
                    <div className="ml-2">
                      ...
                      <div className="w-16 h-2 bg-gray-200 rounded-lg mt-1"></div>
                    </div>
                  </div>
                  
                  {/* Post image - slightly smaller aspect ratio */}
                  <div className="w-full aspect-[4/3] bg-gray-200 rounded-lg mb-2"></div>

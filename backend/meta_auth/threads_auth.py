...
def exchange_threads_code():
    try:
        ...
        if 'error' in token_data or not token_response.ok:
            ...
            return jsonify({'error': f"Failed to exchange code: {error_message}"}), 400
                ...
                if existing_auth.data:
                    ...
                    if existing_account.data:
                        ...
                        account_update = {
                            ...
                            'profile_picture': download_and_encode_image(profile_data.get('threads_profile_picture_url')) if profile_data.get('threads_profile_picture_url') else None
                        }
